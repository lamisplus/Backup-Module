package org.lamisplus.modules.backup;
...
@Slf4j
@EnableSwagger2
public class BackupModule extends AcrossModule
{
    public final static String NAME = "BackupModule";

    public static void main(String[] args) {
        SpringApplication.run (BackupModule.class, args);
    }
